...
const Portfolio = () => {
  ...
  return <section className="py-20 px-6 bg-gray-50" id="portfolio">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-6">
          ...
          <button onClick={() => setShowAllProjects(true)} className="bg-orange-500 text-white px-6 py-3 rounded-full flex items-center gap-2 hover:bg-orange-600 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-8 mb-12">
          {portfolioItems.map((item, index) => <div key={index} className={`group cursor-pointer animate-fade-in`} style={{
