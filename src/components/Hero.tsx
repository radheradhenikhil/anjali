...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20 lg:pt-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-6 animate-fade-in">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            <div className="bg-gray-100 p-4 rounded-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-1 max-w-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6">
            <button className="bg-orange-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-full flex items-center justify-center gap-2 hover:bg-orange-600 transition-all duration-300 hover:scale-105 hover:shadow-lg">
              View Portfolio <ArrowRight className="w-5 h-5" />
            </button>
            <button className="border-2 border-gray-900 text-gray-900 px-6 md:px-8 py-3 md:py-4 rounded-full hover:bg-gray-900 hover:text-white transition-all duration-300 hover:scale-105">
              Hire Me
            </button>
          </div>
        </div>
        ...
        <div className="relative flex justify-center lg:justify-end animate-scale-in" style={{animationDelay: '0.3s'}}>
          <div className="relative">
            <div className="w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-orange-500 rounded-full relative overflow-hidden hover:scale-105 transition-transform duration-500">
              <img 
            ...
            <div className="absolute top-4 right-4 bg-white p-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="text-xl md:text-2xl font-bold text-gray-900 mt-1">5+ Years</div>
